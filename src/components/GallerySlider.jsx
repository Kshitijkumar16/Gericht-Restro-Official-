    ...
    <section id="entire-sub-slider" className="relative">
      <div className="group/ticker ">
        ...
        >
          ...
          >
            <BsInstagram
              className="inset-0 flex items-center justify-center text-white opacity-70 transition-all duration-300 ease-in-out group-hover/logo:cursor-pointer group-hover/ticker:opacity-100 md:w-[23px] lg:w-[28px] xl:w-[35px] lap:w-[40px]"
              size={40}
            />
          </a>
        </div>
